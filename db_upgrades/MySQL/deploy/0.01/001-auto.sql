...
-- Created on Mon Oct 28 20:59:36 2013
-- 
;
...
--
-- Table: `opr_group_user`
--
CREATE TABLE `opr_group_user` (
  `user_id` integer NOT NULL,
  `group_id` integer NOT NULL,
  INDEX `opr_group_user_idx_group_id` (`group_id`),
  INDEX `opr_group_user_idx_user_id` (`user_id`),
  PRIMARY KEY (`user_id`, `group_id`),
  CONSTRAINT `opr_group_user_fk_group_id` FOREIGN KEY (`group_id`) REFERENCES `opr_group` (`group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `opr_group_user_fk_user_id` FOREIGN KEY (`user_id`) REFERENCES `opr_user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
--
